...
object NoammRenderPipelines {
    ...
    val ROUND_RECT: RenderPipeline = RenderPipelines.register(
        RenderPipeline.builder(RenderPipelines.DEBUG_FILLED_SNIPPET)
            .withLocation(Identifier.fromNamespaceAndPath(NoammAddons.MOD_ID, "pipeline/round_rect"))
            .withVertexShader(Identifier.fromNamespaceAndPath(NoammAddons.MOD_ID, "core/round_rect"))
            .withFragmentShader(Identifier.fromNamespaceAndPath(NoammAddons.MOD_ID, "core/round_rect"))
